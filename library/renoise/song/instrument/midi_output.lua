...
---@field instrument_type_observable renoise.Document.Observable **READ-ONLY**
---
...
---@field device_name_observable renoise.Document.Observable **READ-ONLY**
---
...
---@field program_observable renoise.Document.Observable **READ-ONLY**
---
---@field bank integer Range: (1 - 65536) 0 = OFF
---@field bank_observable renoise.Document.Observable **READ-ONLY**
---
---@field delay integer Range: (0 - 100)
---@field delay_observable renoise.Document.Observable **READ-ONLY**
---
---@field duration integer Range: (1 - 8000) 8000 = INF
---@field duration_observable renoise.Document.Observable **READ-ONLY**
