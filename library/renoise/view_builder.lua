...
---@overload fun(self, notifer_method: StringValueNotifierMethod1)
---@overload fun(self, notifer_method: StringValueNotifierMethod2)
...
---@overload fun(self, notifer_method: IntegerValueNotifierMethod1)
---@overload fun(self, notifer_method: IntegerValueNotifierMethod2)
...
---@overload fun(self, notifer_method: NumberValueNotifierMethod1)
---@overload fun(self, notifer_method: NumberValueNotifierMethod2)
...
---@overload fun(self, notifer_method: XYValueNotifierMethod1)
---@overload fun(self, notifer_method: XYValueNotifierMethod2)
