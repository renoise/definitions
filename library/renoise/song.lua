...
---Song Comments
---@field artist string
---@field artist_observable renoise.Document.Observable **READ-ONLY**
---@field name string
...
---
---
---@field sequencer renoise.PatternSequencer **READ-ONLY**
---
---
...
---@field selected_pattern_index_observable renoise.Document.Observable **READ-ONLY**
---
